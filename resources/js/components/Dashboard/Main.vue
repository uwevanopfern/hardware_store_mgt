<template>
  <div class="nk-body npc-subscription has-aside ui-clean">
                    ...
                    <ul class="nk-menu">
                      ...
                      <li class="nk-menu-item">
                        ...
                        <ul class="nk-menu-sub">
                          ...
                          <li class="nk-menu-item">
                            <a href="" class="nk-menu-link"
                              ><span class="nk-menu-text">Team Access</span></a
                            >
                          </li>
                          <li class="nk-menu-item">
                            <a href="" class="nk-menu-link"
                          ...
                          <li class="nk-menu-item">
                            <a href="" class="nk-menu-link"
                              ><span class="nk-menu-text"
                                >Invoices <span class="count">(2)</span></span
                              ></a
                            >
                          </li>
                          <li class="nk-menu-item">
                            <a href="" class="nk-menu-link"
                              ><span class="nk-menu-text">View Invoice</span></a
                            >
                          </li>
                          <li class="nk-menu-item">
                            <a href="" class="nk-menu-link"
                              ><span class="nk-menu-text"
                                >Tickets <span class="count">(5)</span></span
                              ></a
                            >
                          </li>
                          <li class="nk-menu-item">
                      ...
                      <div class="nk-block-between-md g-4">
                        <div class="nk-block-head-content">
                          ...
                          <div class="nk-block-des">
                            <p>
                              Welcome to our dashboard. Manage your account and
                              your subscriptions.
                            </p>
                          </div>
                        </div>
                            ...
                            <div class="nk-wg1">
                              <div class="nk-wg1-block">
                                ...
                                <div class="nk-wg1-text">
                                  ...
                                  <p>
                                    See your profile data and manage your
                                    Account to choose what is saved in our
                                    system.
                                  </p>
                                </div>
                              </div>
                            ...
                            <div class="nk-wg1">
                              <div class="nk-wg1-block">
                                ...
                                <div class="nk-wg1-text">
                                  ...
                                  <p>
                                    You have full control to manage your own
                                    account and keep account fully secure.
                                  </p>
                                </div>
                              </div>
                              <div class="nk-wg1-action">
                            ...
                            <div class="nk-wg1">
                              <div class="nk-wg1-block">
                                ...
                                <div class="nk-wg1-text">
                                  ...
                                  <p>
                                    Check out all your payment history. You can
                                    also download or print your invoice.
                                  </p>
                                </div>
                              </div>
                              <div class="nk-wg1-action">
                            ...
                            <div class="nk-wg1">
                              <div class="nk-wg1-block">
                                ...
                                <div class="nk-wg1-text">
                                  ...
                                  <p>
                                    Check your reports of uses and manage your
                                    packages or subscriptions that you have.
                                  </p>
                                </div>
                              </div>
                              <div class="nk-wg1-action">
                          ...
                          <div class="card-inner">
                            ...
                            >
                              <div class="nk-block-text">
                                ...
                                <p class="text-soft">
                                  Unlimited access with priority support, 99.95%
                                  uptime, powerfull features and more...
                                </p>
                              </div>
                          ...
                          <thead>
                            <tr class="tb-tnx-head">
                              ...
                              <th class="tb-tnx-amount">
                                ...
                                <span
                                  class="tb-tnx-status d-none d-md-inline-block"
                                  >Status</span
                                >
                              </th>
                            </tr>
                          ...
                          <tbody>
                            <tr class="tb-tnx-item">
                              ...
                              <td class="tb-tnx-info">
                                <div class="tb-tnx-desc">
                                  <span class="title"
                                    >Enterprize Year Subscrition</span
                                  >
                                </div>
                            ...
                            <tr class="tb-tnx-item">
                              ...
                              <td class="tb-tnx-info">
                                <div class="tb-tnx-desc">
                                  <span class="title"
                                    >Maintenance Year Subscription</span
                                  >
                                </div>
                                <div class="tb-tnx-date">
